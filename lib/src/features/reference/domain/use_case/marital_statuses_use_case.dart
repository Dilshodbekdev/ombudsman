...
class MaritalStatusesUseCase implements UseCase<DataState<List<StatusModel>>, int> {
  final AppealRepository _repository;

  MaritalStatusesUseCase(this._repository);

  @override
  Future<DataState<List<StatusModel>>> call({required int params}) async =>
      await _repository.maritalStatuses();
}
